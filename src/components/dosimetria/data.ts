...
export const AGRAVANTES_LIST: ListItem[] = [
  ...
  { code: "Art. 61, II, a", desc: "Motivo fútil ou torpe" },
  { code: "Art. 61, II, b", desc: "Facilitar ou assegurar execução, ocultação, impunidade ou vantagem de outro crime" },
  { code: "Art. 61, II, c", desc: "Traição, emboscada, dissimulação ou recurso que dificultou ou impossibilitou a defesa" },
  { code: "Art. 61, II, d", desc: "Emprego de veneno, fogo, explosivo, tortura, meio insidioso ou cruel, ou perigo comum" },
  { code: "Art. 61, II, e", desc: "Contra ascendente, descendente, irmão ou cônjuge" },
  { code: "Art. 61, II, f", desc: "Abuso de autoridade, relações domésticas, coabitação, hospitalidade ou violência contra a mulher" },
  { code: "Art. 61, II, g", desc: "Abuso de poder ou violação de dever inerente a cargo, ofício, ministério ou profissão" },
  { code: "Art. 61, II, h", desc: "Contra criança, maior de 60 anos, enfermo ou mulher grávida" },
  { code: "Art. 61, II, i", desc: "Quando o ofendido estava sob a imediata proteção da autoridade" },
  { code: "Art. 61, II, j", desc: "Em incêndio, naufrágio, inundação, calamidade pública ou desgraça particular do ofendido" },
  { code: "Art. 61, II, l", desc: "Em estado de embriaguez preordenada" },
  { code: "Art. 61, II, m", desc: "Nas dependências de instituição de ensino" },
  { code: "Art. 62, I", desc: "Promoveu ou organizou a cooperação no crime" },
  { code: "Art. 62, II", desc: "Coagiu ou induziu outrem à execução material do crime" },
  { code: "Art. 62, III", desc: "Instigou ou determinou crime a pessoa sujeita à sua autoridade ou não punível" },
  { code: "Art. 62, IV", desc: "Executou ou participou mediante paga ou promessa de recompensa" },
];

export const ATENUANTES_LIST: ListItem[] = [
  { code: "Art. 65, I", desc: "Menor de 21 anos no fato ou maior de 70 na sentença, salvo violência sexual contra a mulher" },
  { code: "Art. 65, II", desc: "Desconhecimento da lei" },
  { code: "Art. 65, III, a", desc: "Motivo de relevante valor social ou moral" },
  { code: "Art. 65, III, b", desc: "Evitou ou minorou consequências do crime, ou reparou o dano antes do julgamento" },
  { code: "Art. 65, III, c", desc: "Coação resistível, ordem de autoridade superior ou violenta emoção por ato injusto da vítima" },
...
export const MAJORANTES_LIST: ListItem[] = [
  { code: "Art. 70", desc: "Concurso formal próprio — aumento de 1/6 até metade" },
  { code: "Art. 71", desc: "Crime continuado — aumento de 1/6 a 2/3" },
  { code: "Art. 121, § 2º-B, I", desc: "Homicídio contra menor de 14 anos com deficiência ou doença — aumento de 1/3 até metade" },
  { code: "Art. 121, § 2º-B, II/III", desc: "Homicídio contra menor de 14 anos nas hipóteses legais — aumento de 2/3" },
  { code: "Art. 129, § 7º", desc: "Lesão corporal com hipóteses dos §§ 4º e 6º do art. 121 — aumento de 1/3" },
  { code: "Art. 129, § 8º-A", desc: "Lesão por organização criminosa ultraviolenta, grupo paramilitar ou milícia — aumento de 2/3" },
  { code: "Art. 155, § 1º", desc: "Furto durante repouso noturno — aumento de metade" },
  { code: "Art. 155, § 4º-C, I", desc: "Furto eletrônico com servidor fora do Brasil — aumento de 1/3 a 2/3" },
  { code: "Art. 157, § 2º", desc: "Roubo nas hipóteses do § 2º — aumento de 1/3 até metade" },
  { code: "Art. 157, § 2º-A", desc: "Roubo com arma de fogo ou explosivo — aumento de 2/3" },
  { code: "Art. 158, § 1º", desc: "Extorsão por duas ou mais pessoas ou com emprego de arma — aumento de 1/3 até metade" },
  { code: "Legislação especial", desc: "Outro aumento previsto em lei especial" },
];

export const MINORANTES_LIST: ListItem[] = [
  { code: "Art. 14, parágrafo único", desc: "Tentativa — redução de 1/3 a 2/3" },
  { code: "Art. 16", desc: "Arrependimento posterior — redução de 1/3 a 2/3" },
  { code: "Art. 21", desc: "Erro evitável sobre a ilicitude — redução de 1/6 a 1/3" },
  { code: "Art. 24, § 2º", desc: "Estado de necessidade com sacrifício razoavelmente exigível — redução de 1/3 a 2/3" },
  { code: "Art. 26, parágrafo único", desc: "Semi-imputabilidade — redução de 1/3 a 2/3" },
  { code: "Art. 29, § 1º", desc: "Participação de menor importância — redução de 1/6 a 1/3" },
  { code: "Art. 121, § 1º", desc: "Homicídio privilegiado — redução de 1/6 a 1/3" },
  { code: "Art. 129, § 4º", desc: "Lesão corporal privilegiada — redução de 1/6 a 1/3" },
  { code: "Art. 155, § 2º", desc: "Furto privilegiado — diminuição de 1/3 a 2/3 ou substituição" },
...
export const PRESCRICAO: PrescricaoFaixa[] = [
  ...
  { faixa: "Igual a 1 ano ou acima de 1 até 2 anos", prazo: 4 },
  { faixa: "Inferior a 1 ano", prazo: 3 },
];

export const FRACS = ["1/8","1/6","1/5","1/4","1/3","1/2","2/3"] as const;
